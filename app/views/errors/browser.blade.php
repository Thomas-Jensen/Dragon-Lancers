...
@section('content')
    ...
    <section class="error">
        <figure>
            <a href="http://www.dragonlancers.com"><img src="{{ URL::asset('assets/images/build/cute-mr-dragon-error-page123.png') }}" width="100%" alt="Please get a good modern browser..."> </a>
            <figcaption>
