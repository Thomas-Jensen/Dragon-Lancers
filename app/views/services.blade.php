...
<figure class="blue-ink">
    <img src="{{ asset('assets/images/build/blue-ink-services.png') }}" width="100%" alt="blue ink">
</figure>
...
<g>
    ...
    <figure class="services-subs">
        <svg xmlns="http://www.w3.org/2000/svg"  id="Layer_1" x="0px" y="0px" width="15.688em" height="7.688em" viewBox="0 0 600 300" enable-background="new 0 0 600 300" xml:space="preserve">
<g>
    <path fill="#00ACEE" d="M343.369,57.051H226.646c-3.019,0-5.472,1.805-5.472,4.037c0,2.231,2.453,4.037,5.472,4.037H343.37   c3.021,0,5.474-1.806,5.474-4.037C348.843,58.856,346.39,57.051,343.369,57.051z"/>
    <path fill="#00ACEE" d="M343.369,89.602H226.646c-3.019,0-5.472,1.809-5.472,4.038c0,2.233,2.453,4.038,5.472,4.038H343.37   c3.021,0,5.474-1.805,5.474-4.038C348.843,91.411,346.39,89.602,343.369,89.602z"/>
    <path fill="#00ACEE" d="M344.461,120.119H227.736c-3.021,0-5.472,1.805-5.472,4.035c0,2.234,2.45,4.04,5.472,4.04h116.725   c3.021,0,5.471-1.805,5.471-4.04C349.932,121.924,347.481,120.119,344.461,120.119z"/>
</g>
            <rect x="98.406" y="182" fill="none" width="400" height="62"/>
            <text transform="matrix(1 0 0 1 98.4063 214.8994)" font-family="'NixieOne'" font-size="47">SUBSCRIPTIONS</text>
</svg>
    </figure>
</section>
    ...
    <section class="service-content">
        <article>
            <p class="service-txt-print">
                "We love setting up text, creating logos and images for your campaigns.
                We can create anything from a simple brochure to large  projects lasting years"
            </p>
            <p class="service-txt-web">
                "We love websites, we create responsive modern sites, simple but powerful.
                We work hard to optimise SEO, UI, UX and e-commerce, we love the web"
            </p>
            <p class="service-txt-apps">
                "We love apps, we create anything from small games and applications to large scale industrial apps connecting to websites
                and stores around the globe"
            </p>
    ...
    <section class="service-showcase">
        <figure>
            <picture class="service-img-print">
                <source media="(max-width:800px)" srcset="{{ asset('assets/images/build/print-service.jpg') }}">
                <source media="(min-width:800px)" srcset="{{ asset('assets/images/build/services-print-picture.jpg') }}">
                <img src="{{ asset('assets/images/build/services-print-picture.jpg') }}" width="100%">
            </picture>
            <picture class="service-img-web">
                <source media="(max-width:800px)" srcset="{{ asset('assets/images/build/web.jpg') }}">
                <source media="(min-width:800px)" srcset="{{ asset('assets/images/build/services-web-picture.jpg') }}">
                <img src="{{ asset('assets/images/build/services-web-picture.jpg') }}" width="100%">
            </picture>
            <picture class="service-img-apps">
                <source media="(max-width:800px)" srcset="{{ asset('assets/images/build/apps.jpg') }}">
                <source media="(min-width:800px)" srcset="{{ asset('assets/images/build/services-apps-picture.jpg') }}">
                <img src="{{ asset('assets/images/build/services-apps-picture.jpg') }}" width="100%">
            </picture>
            <picture class="service-img-subs">
                <source media="(max-width:800px)" srcset="{{ asset('assets/images/build/subs.jpg') }}">
                <source media="(min-width:800px)" srcset="{{ asset('assets/images/build/services-subscriptions-picture.jpg') }}">
                <img src="{{ asset('assets/images/build/services-subscriptions-picture.jpg') }}" width="100%">
            </picture>
        </figure>
    </section>
</section>
